...
export default function Gender() {
  ...
  //  }, []);
  return (
    <div className=' mx-auto w-[400px] my-20 bgg px-4 pb-8 rounded-xl border-4 border-double border-blue-100 shadow-2xl'>
  ...
  <button type="submit" class="text-pink-700 hover:bg-pink-300 hover:text-white font-bold bg-pink-200 focus:ring-4 focus:outline-none focus:ring-pink-400 rounded-md text-sm w-max sm:w-auto px-5 py-2.5 text-center " onClick={handleClick} >Identify here</button>
  {show ? (
    <>
